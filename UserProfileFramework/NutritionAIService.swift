...
public class NutritionAIService: ObservableObject {
    @Published public var currentRecommendation: NutritionRecommendation?
    @Published public var mealSuggestions: [MealSuggestion] = []
    @Published public var isLoading: Bool = false
    
    public init() { }
    
    public func generateRecommendations(userProfile: UserProfileManager, healthData: HealthKitManager) {
        isLoading = true
    ...
    // 针对特定时间生成膳食建议
    public func getMealForCurrentTime() -> MealSuggestion? {
